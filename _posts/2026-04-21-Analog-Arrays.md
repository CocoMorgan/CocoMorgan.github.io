...
For the Analog Arrays assignment, I wrote an Arduino program that every 1 second, and when appropriate, turns on a random PWM pin to a a random value, or turns that pin off.
